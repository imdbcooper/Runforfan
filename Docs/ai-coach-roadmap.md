...
**Статус: в работе. Инкремент 6.1 завершён 14 июля 2026 года; полный этап 6 не завершён.**
...
На 14 июля 2026 года этапы 1-5 и отдельный инкремент Stage 6.1 завершены. Полный Stage 6 остаётся в работе. Текущий код включает immutable action ledger, compensating rollback, event-driven recalculation assessments, historical resolver, deterministic Weekly Review, Hybrid Conversational Coach, normalized Recovery/Wearable Signals и controlled read-only Telegram daily brief.
...
Следующая точка продолжения: Stage 6.2, post-workout и weekly delivery loops. Они должны использовать существующие deterministic projections, preview/apply boundary, audit/version ledger и conservative fallback; Telegram остаётся read-only каналом.

## Порядок ближайших инкрементов

1. Расширить завершённый daily Telegram loop на post-workout и weekly read-only briefs поверх существующих projections.
