...
from app.api.routes import account, activities, analytics, audit_log, auth, calendar, coaching_events, dashboard, export, goals, imports, performance, planning, profile, readiness, settings as settings_routes, zones
