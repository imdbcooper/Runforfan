...
export function DataTable<T>({ rows, columns, getSearchText, getRowKey, pageSize = 8, minWidthClassName = "min-w-[720px]", emptyState, filterPlaceholder = "Filter" }: DataTableProps<T>) {
  ...
  return <div className="grid gap-3">
    <div className="flex flex-wrap items-center justify-between gap-2 px-4 pt-4 text-xs">
      <Input className="max-w-xs" value={filter} placeholder={filterPlaceholder} onChange={(event) => setFilter(event.target.value)} />
